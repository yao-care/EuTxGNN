...
- `eu_regulatory`: EMA marketing authorization and market status in the European Union
...
| Item | Content |
|------|------|
| Original Indication | [Extract from eu_regulatory.licenses, use first non-empty approved_indication_text] |
...
| EU Market Status | [Extract from eu_regulatory.market_status] |
| Number of Authorizations | [Extract from eu_regulatory.total_licenses] |
...
Extract from `eu_regulatory.licenses` and create table:

| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| EU/1/XX/XXX | Product name | Form | Indication summary |
...
| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| EU/1/XX/XXX | TS-One | Capsule | Gastric cancer, pancreatic cancer, colorectal cancer, NSCLC... |
