...
import pandas as pd
from eutxgnn.collectors import DrugBundleAggregator
from eutxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from eutxgnn.collectors.drug_bundle import PredictedIndication
    from eutxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from eutxgnn.collectors.drug_bundle import DrugBundle
