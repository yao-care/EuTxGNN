...
parent: 健康新聞
nav_exclude: true
description: "Alzheimer's（alzheimer disease） 的相關健康新聞報導。6 則新聞、16 個相關藥物。"
...
<strong>Alzheimer's（alzheimer disease）</strong> 目前有 <strong>6 則</strong>相關新聞報導，16 個相關藥物。
</p>
...
<li><a href="{{ '/drugs/carbidopa/' | relative_url }}">Carbidopa</a></li>
<li><a href="{{ '/drugs/ceritinib/' | relative_url }}">Ceritinib</a></li>
<li><a href="{{ '/drugs/crizotinib/' | relative_url }}">Crizotinib</a></li>
<li><a href="{{ '/drugs/dasatinib-monohydrate/' | relative_url }}">Dasatinib Monohydrate</a></li>
<li><a href="{{ '/drugs/entacapone/' | relative_url }}">Entacapone</a></li>
<li><a href="{{ '/drugs/erlotinib/' | relative_url }}">Erlotinib</a></li>
<li><a href="{{ '/drugs/gefitinib/' | relative_url }}">Gefitinib</a></li>
<li><a href="{{ '/drugs/levodopa/' | relative_url }}">Levodopa</a></li>
<li><a href="{{ '/drugs/lorlatinib/' | relative_url }}">Lorlatinib</a></li>
<li><a href="{{ '/drugs/opicapone/' | relative_url }}">Opicapone</a></li>
<li><a href="{{ '/drugs/pembrolizumab/' | relative_url }}">Pembrolizumab</a></li>
<li><a href="{{ '/drugs/ponatinib/' | relative_url }}">Ponatinib</a></li>
<li><a href="{{ '/drugs/rasagiline/' | relative_url }}">Rasagiline</a></li>
<li><a href="{{ '/drugs/tolcapone/' | relative_url }}">Tolcapone</a></li>
</ul>
</div>
