---
layout: default
title: "Somapacitan 相關新聞"
parent: 健康新聞
nav_exclude: true
description: "Somapacitan 的相關健康新聞報導。原適應症：Sogroya is indicated for the replacement of endoge...。預測適應症 20 個。"
permalink: /news/somapacitan/
---
...
本頁整合 Somapacitan 的 AI 預測適應症與最新健康新聞，橘色標示的適應症表示近期有相關新聞報導。
</div>

<div class="drug-info-card">
<strong>藥物資訊</strong>
<ul>
<li><strong>原適應症</strong>：Sogroya is indicated for the replacement of endogenous growth hormone (GH) in children &nbsp;aged 3 &nbsp;years and above, and adolescents with growth failure due to growth hormone deficiency...</li>
<li><strong>證據等級</strong>：L5</li>
<li><strong>預測適應症</strong>（20 個）：<ul>
<li>allergic asthma（95.7%）</li>
<li>intrinsic asthma（95.3%）</li>
<li>brain small vessel disease 1 with or without ocular anomalies（92.1%）</li>
<li>autosomal dominant familial hematuria-retinal arteriolar tortuosity-contractures syndrome（92.1%）</li>
<li>renin-angiotensin-aldosterone system-blocker-induced angioedema（91.8%）</li>
<li>gout（91.6%）</li>
<li>autoimmune hemolytic anemia（91.2%）</li>
<li>diabetic nephropathy（91.0%）</li>
<li>asthma-related traits, susceptibility to（89.7%）</li>
<li>disorder of GPI anchor biosynthesis（89.3%）</li>
<li>acquired aplastic anemia（88.8%）</li>
...
<li>myositis fibrosa（84.8%）</li>
<li>migraine disorder（84.3%）</li>
</ul></li>
</ul>
