---
layout: default
title: "Prasterone 相關新聞"
parent: 健康新聞
nav_exclude: true
description: "Prasterone 的相關健康新聞報導。原適應症：Intrarosa is indicated for the treatment of vulvar...。預測適應症 20 個。"
permalink: /news/prasterone/
---
...
本頁整合 Prasterone 的 AI 預測適應症與最新健康新聞，橘色標示的適應症表示近期有相關新聞報導。
</div>

<div class="drug-info-card">
<strong>藥物資訊</strong>
<ul>
<li><strong>原適應症</strong>：Intrarosa is indicated for the treatment of vulvar and vaginal atrophy in postmenopausal women having moderate to severe symptoms.</li>
...
<li>thrombophilia（99.9%）</li>
<li>pediatric systemic lupus erythematosus（99.2%）</li>
<li>severe nonproliferative diabetic retinopathy（99.2%）</li>
<li>thrombophilia due to protein S deficiency, autosomal recessive（99.1%）</li>
<li>scleroderma (disease)（99.1%）</li>
<li>complement component 4a deficiency（99.0%）</li>
<li>pseudo-von Willebrand disease（99.0%）</li>
<li>primary release disorder of platelets（99.0%）</li>
<li>acne (disease)（98.5%）</li>
<li>anus disease（97.8%）</li>
<li>granulomatous disease, chronic, autosomal recessive, 5（97.4%）</li>
<li>inflammatory bowel disease（97.3%）</li>
<li>granulomatous disease with defect in neutrophil chemotaxis（97.2%）</li>
<li>fetal and neonatal alloimmune thrombocytopenia（97.0%）</li>
<li>peeling skin syndrome（97.0%）</li>
<li>spondyloarthropathy, susceptibility to（97.0%）</li>
<li>diabetic retinopathy（96.9%）</li>
</ul></li>
</ul>
