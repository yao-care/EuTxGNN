...
parent: 健康新聞
nav_exclude: true
description: "Avelumab 的相關健康新聞報導。原適應症：Bavencio is indicated as monotherapy for the treat...。預測適應症 20 個。"
...
<strong>Avelumab</strong> 目前有 <strong>32 則</strong>相關新聞報導，預測適應症 20 個。
</p>
...
<li>infiltrating bladder urothelial carcinoma sarcomatoid variant（99.9%）</li>
<li>renal pelvis papillary urothelial carcinoma（99.9%）</li>
<li>lung fibrosis-immunodeficiency-46,XX gonadal dysgenesis syndrome（99.9%）</li>
<li>severe combined immunodeficiency due to LCK deficiency（99.9%）</li>
<li>T-B+ severe combined immunodeficiency due to gamma chain deficiency（99.9%）</li>
<li>T-B+ severe combined immunodeficiency due to CD45 deficiency（99.9%）</li>
<li>severe combined immunodeficiency (disease)（99.9%）</li>
<li>combined immunodeficiency, X-linked（99.9%）</li>
<li>glottis verrucous carcinoma（99.8%）</li>
<li>severe combined immunodeficiency, autosomal recessive, T cell-negative, B cell-negative, NK cell-positive（99.8%）</li>
</ul></li>
</ul>
