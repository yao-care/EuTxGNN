...
parent: 健康新聞
nav_exclude: true
description: "esclerosis múltiple（multiple sclerosis） 的相關健康新聞報導。22 則新聞、26 個相關藥物。"
...
<strong>esclerosis múltiple（multiple sclerosis）</strong> 目前有 <strong>22 則</strong>相關新聞報導，26 個相關藥物。
</p>
