---
layout: default
title: "Herzerkrankung (heart disease) News"
parent: 📰 Health News
nav_exclude: true
description: "Health news about Herzerkrankung (heart disease). 3 articles, 57 related drugs."
permalink: /news/heart-disease/
---

# Herzerkrankung (heart disease) News

[← Back to News Overview]({{ '/news/' | relative_url }})

---

<p class="key-answer" data-question="What news is there about Herzerkrankung (heart disease)?">
<strong>Herzerkrankung (heart disease)</strong> currently has <strong>3 news articles</strong> and 57 related drugs.
</p>

<div class="key-takeaway">
This page brings together the latest health news about “Herzerkrankung” and lists the drugs in the EuTxGNN database whose predicted indications include this disease.
</div>
...
<li><a href="{{ '/drugs/atosiban-as-acetate/' | relative_url }}">Atosiban (As Acetate)</a></li>
...
<li><a href="{{ '/drugs/cangrelor/' | relative_url }}">Cangrelor</a></li>
<li><a href="{{ '/drugs/capsaicin/' | relative_url }}">Capsaicin</a></li>
<li><a href="{{ '/drugs/clopidogrel/' | relative_url }}">Clopidogrel</a></li>
...
<li><a href="{{ '/drugs/dalbavancin-hydrochloride/' | relative_url }}">Dalbavancin Hydrochloride</a></li>
...
<li><a href="{{ '/drugs/laronidase/' | relative_url }}">Laronidase</a></li>
<li><a href="{{ '/drugs/lonafarnib/' | relative_url }}">Lonafarnib</a></li>
<li><a href="{{ '/drugs/lumacaftor/' | relative_url }}">Lumacaftor</a></li>
<li><a href="{{ '/drugs/macimorelin-acetate/' | relative_url }}">Macimorelin Acetate</a></li>
...
<li><a href="{{ '/drugs/perflutren/' | relative_url }}">Perflutren</a></li>
<li><a href="{{ '/drugs/prasugrel/' | relative_url }}">Prasugrel</a></li>
<li><a href="{{ '/drugs/pretomanid/' | relative_url }}">Pretomanid</a></li>
<li><a href="{{ '/drugs/propranolol-hydrochloride/' | relative_url }}">Propranolol Hydrochloride</a></li>
<li><a href="{{ '/drugs/remdesivir/' | relative_url }}">Remdesivir</a></li>
<li><a href="{{ '/drugs/reteplase/' | relative_url }}">Reteplase</a></li>
