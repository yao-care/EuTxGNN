...
layout: default
title: Cobicistat
description: "cobicistat drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| HIV infectious disease | L1 | 20 | 0 | 6 Phase 3 trial(s), 2 Phase 2 trial(s) |
