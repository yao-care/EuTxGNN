...
layout: default
title: Lacosamide
description: "lacosamide drug repurposing predictions from TxGNN. Evidence level L4 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| manic bipolar affective disorder | L4 | 1 | 0 | 1 Phase 3 trial(s) |
