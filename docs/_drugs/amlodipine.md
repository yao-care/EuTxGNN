...
layout: default
title: Amlodipine
description: "amlodipine drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| cerebrovascular disorder | L1 | 20 | 0 | 5 Phase 3 trial(s), 1 Phase 2 trial(s) |
| Prinzmetal angina | L1 | 7 | 4 | 2 Phase 3 trial(s), 2 Phase 2 trial(s) |
