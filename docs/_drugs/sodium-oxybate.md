...
description: "sodium oxybate drug repurposing predictions from TxGNN. Evidence level L2 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| insomnia (disease) | L2 | 13 | 0 | 1 Phase 3 trial(s), 5 Phase 2 trial(s) |
