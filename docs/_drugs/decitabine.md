...
|------|------|------|---------|-------------|
| [35624441](https://pubmed.ncbi.nlm.nih.gov/35624441/) | 2022 | Retrospective Cohort | BMC Pediatrics | Single-center 10-year experience with Decitabine combined minimally myelosuppressive regimen (DAC + MMR) as bridging therapy to allo-HSCT in children with MDS (including RCC). Reports feasibility and transplant outcomes, supporting Decitabine's role as a pre-transplant cytoreductive strategy in the pediatric setting. |
