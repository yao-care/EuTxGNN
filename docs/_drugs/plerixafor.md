...
layout: default
title: Plerixafor
description: "plerixafor drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| plasma cell myeloma | L1 | 20 | 1 | 3 Phase 3 trial(s), 8 Phase 2 trial(s) |
