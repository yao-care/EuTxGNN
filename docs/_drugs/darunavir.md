...
layout: default
title: Darunavir
description: "darunavir drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| HIV infectious disease | L1 | 20 | 0 | 2 Phase 3 trial(s), 4 Phase 2 trial(s) |
