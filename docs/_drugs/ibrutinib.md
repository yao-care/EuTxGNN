...
This dataset records **zero EU marketing authorizations** for Ibrutinib (`total_licenses = 0`, `market_status = Not marketed / Not Marketed`). No license table is available.
