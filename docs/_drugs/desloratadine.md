...
layout: default
title: Desloratadine
description: "desloratadine drug repurposing predictions from TxGNN. Evidence level L1 with 53 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| allergic urticaria | L1 | 6 | 0 | 1 Phase 3 trial(s) |
