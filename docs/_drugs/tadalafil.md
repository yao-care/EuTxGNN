...
layout: default
title: Tadalafil
description: "tadalafil drug repurposing predictions from TxGNN. Evidence level L1 with 53 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| benign prostatic hyperplasia (disease) | L1 | 20 | 0 | 7 Phase 3 trial(s), 5 Phase 2 trial(s) |
