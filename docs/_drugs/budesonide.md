...
layout: default
title: Budesonide
description: "budesonide drug repurposing predictions from TxGNN. Evidence level L4 with 52 predicted indications."
...
Evidence Level: **L4** | Predicted Indications: **52**
{: .fs-6 .fw-300 }
...
|------------|:-----:|:------:|:--------:|---------|
| atopic eczema | L4 | 2 | 4 | AI prediction only |
