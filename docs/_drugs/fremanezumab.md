...
layout: default
title: Fremanezumab
description: "fremanezumab drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| migraine disorder | L1 | 20 | 1 | 7 Phase 3 trial(s), 4 Phase 2 trial(s) |
