...
Brexpiprazole is a serotonin-dopamine activity modulator (atypical antipsychotic) with established FDA approval for schizophrenia and as adjunctive therapy for major depressive disorder (MDD), though it is currently not marketed in the European Union or Taiwan.
The TxGNN model predicts it may be effective for **Dysthymic Disorder** (now classified as Persistent Depressive Disorder, PDD),
with **0 clinical trials** and **0 publications** directly addressing this specific indication — though mechanistic rationale and indirect evidence from MDD augmentation trials underpin the hypothesis.
