...
layout: default
title: Tasonermin
description: "Tasonermin drug repurposing predictions from TxGNN. Evidence level L5 with 3 predicted indications."
...
| Item | Value |
|------|-------|
| Drug Name | Tasonermin |
| DrugBank ID | [DB11626](https://go.drugbank.com/drugs/DB11626) |
| Brand Names (EU) | Beromun |
| Evidence Level | L5 |
| Predicted Indications | 3 |
...
|:----:|------------|------:|--------|
| 1 | cancer | 50.00% | KG |
| 2 | soft tissue sarcoma | 50.00% | KG |
| 3 | sarcoma | 50.00% | KG |
