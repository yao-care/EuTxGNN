...
layout: default
title: Ustekinumab
description: "ustekinumab drug repurposing predictions from TxGNN. Evidence level L1 with 51 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| dermatitis | L1 | 7 | 20 | 1 Phase 3 trial(s), 3 Phase 2 trial(s), 2 RCT(s),  |
