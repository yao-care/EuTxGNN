...
layout: default
title: Romiplostim
description: "romiplostim drug repurposing predictions from TxGNN. Evidence level L1 with 51 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| platelet-type bleeding disorder | L1 | 8 | 0 | 2 Phase 3 trial(s), 2 Phase 2 trial(s) |
