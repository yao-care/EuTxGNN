...
No EU marketing authorizations are on file. `market_status = "Not marketed" (Not Marketed)`, `total_licenses = 0`. Lusutrombopag currently has no recorded EU regulatory presence in this evidence pack.
