...
Pembrolizumab currently has no EU marketing authorization on file in this evidence pack (`market_status: Not marketed`, `total_licenses: 0`). No authorization records are available to list.
