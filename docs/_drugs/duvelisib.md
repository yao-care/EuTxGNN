...
Duvelisib currently has **no EU marketing authorization on file** (`total_licenses: 0`, `market_status: Not marketed`). No product/authorization table can be produced from the available data.
