...
Givosiran currently holds **0 authorizations** in the Taiwan regulatory dataset (`market_status: 未上市` / not marketed). No license records are available to summarize dosage form or approved indication text.
