...
layout: default
title: Givosiran
description: "givosiran drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| hepatic porphyria | L1 | 6 | 17 | 1 Phase 3 trial(s), 2 RCT(s) |
