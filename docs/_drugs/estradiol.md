...
layout: default
title: Estradiol
description: "estradiol drug repurposing predictions from TxGNN. Evidence level L1 with 53 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| acne (disease) | L1 | 20 | 1 | 1 Phase 3 trial(s), 1 Phase 2 trial(s) |
