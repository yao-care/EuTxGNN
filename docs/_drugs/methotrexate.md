...
Methotrexate is currently **not marketed** in this jurisdiction (market status: Not marketed), and no marketing authorization records are available in this dataset (0 total licenses).
