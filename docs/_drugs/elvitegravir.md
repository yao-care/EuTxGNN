...
layout: default
title: Elvitegravir
description: "elvitegravir drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| HIV infectious disease | L1 | 20 | 0 | 5 Phase 3 trial(s), 7 Phase 2 trial(s) |
