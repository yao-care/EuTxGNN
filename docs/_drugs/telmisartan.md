...
layout: default
title: Telmisartan
description: "telmisartan drug repurposing predictions from TxGNN. Evidence level L1 with 51 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| stroke disorder | L1 | 20 | 0 | 3 Phase 3 trial(s), 1 Phase 2 trial(s) |
