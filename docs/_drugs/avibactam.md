...
layout: default
title: Avibactam
description: "avibactam drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| pyelonephritis | L1 | 4 | 20 | 2 Phase 3 trial(s), 1 Phase 2 trial(s), 2 RCT(s),  |
