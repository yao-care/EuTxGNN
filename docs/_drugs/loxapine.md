...
layout: default
title: Loxapine
description: "loxapine drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| schizophrenia | L1 | 14 | 0 | 2 Phase 3 trial(s), 3 Phase 2 trial(s) |
