...
layout: default
title: Eptinezumab
description: "eptinezumab drug repurposing predictions from TxGNN. Evidence level L1 with 50 predicted indications."
...
|------------|:-----:|:------:|:--------:|---------|
| migraine disorder | L1 | 20 | 2 | 7 Phase 3 trial(s), 1 Phase 2 trial(s) |
