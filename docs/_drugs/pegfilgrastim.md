...
Pegfilgrastim currently has no marketing authorization records in this evidence pack — `taiwan_regulatory.total_licenses` is 0 and `market_status` is "Not marketed" (Not marketed). No product license table is available.
