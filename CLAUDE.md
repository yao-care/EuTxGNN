...
| 證據收集系統 | ✅ | ClinicalTrials.gov + PubMed |
| 自動化監控 | ✅ | 每日兩次檢查新證據 |
| 健康新聞監控 | ✅ | 每小時抓取歐洲新聞 |
...
| 等級 | 數量 | 說明 |
|------|------|------|
| L1 | 93 | Phase 3+ 臨床試驗證據 |
| L2 | 20 | Phase 2 臨床試驗證據 |
| L3 | 3 | 觀察性研究證據 |
| L4 | 8 | 臨床前/機制證據 |
| L5 | 518 | AI 預測（無臨床證據） |
| **總計** | **642** | |
...
| 頁面 | 路徑 | 說明 |
|------|------|------|
| High Evidence | `/evidence-high/` | L1 (93) + L2 (20) 藥物 |
| Medium Evidence | `/evidence-medium/` | L3 (3) + L4 (8) 藥物 |
| AI Predictions | `/evidence-low/` | L5 (518) 藥物 |
