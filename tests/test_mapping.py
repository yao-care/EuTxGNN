...
class TestDrugBankMapper:
    ...
    def test_import_drugbank_mapper(self):
        ...
        from eutxgnn.mapping.drugbank_mapper import load_drugbank_vocab, map_ingredient_to_drugbank
    ...
    def test_load_drugbank_vocab(self):
        ...
        from eutxgnn.mapping.drugbank_mapper import load_drugbank_vocab
...
class TestDiseaseMapper:
    ...
    def test_import_disease_mapper(self):
        ...
        from eutxgnn.mapping.disease_mapper import extract_indications, translate_indication
    ...
    def test_extract_indications_basic(self):
        ...
        from eutxgnn.mapping.disease_mapper import extract_indications
...
class TestNormalizer:
    ...
    def test_import_normalizer(self):
        ...
        from eutxgnn.mapping.normalizer import normalize_ingredient, extract_ingredients
        assert normalize_ingredient is not None
        assert extract_ingredients is not None

    def test_normalize_basic(self):
        """Test basic drug name normalization."""
        from eutxgnn.mapping.normalizer import normalize_ingredient
    ...
    def test_extract_ingredients(self):
        ...
        from eutxgnn.mapping.normalizer import extract_ingredients
